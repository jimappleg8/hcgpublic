...
<!-- section 4 -->
   ...
   {if $nutfacts.NIACP != "" }
      <tr>
      <td colspan="5" class="Nutrition">Folate</td>
      <td class="Nutrition"><div align="right">{$nutfacts.FOLATEP}%</div></td>
      <td colspan="3" class="Nutrition"><div align="right">{$nutfacts.2FOLATEP}%</div></td>
      </tr>
      {draw_line_wide width="1" indent="no"}
   {/if}
