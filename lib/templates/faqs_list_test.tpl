...
<p>This first section shows how a list can be generated to link to other pages where each question and answer has it's own page.</p>
   ...
   {section name="faq" loop="$faqs"}
      {if $faqs[faq].shortquestion != "" }
         <li><a href="/faqs/faq_detail.php?faq_num={$faqs[faq].faqid}">{$faqs[faq].shortquestion}</a></li>
      {else}
         <li><a href="/faqs/faq_detail.php?faq_num={$faqs[faq].faqid}">{$faqs[faq].question}</a></li>      
      {/if}
   {/section}
   </ul>
...
<p>This section creates a list with anchor links to sections within the same page. This is how you can list all the FAQs on a single page.</p>
   ...
   {section name="faq" loop="$faqs"}
      {if $faqs[faq].shortquestion != "" }
         <li><a href="/faqs/faq_test.php#faqid{$faqs[faq].faqid}">{$faqs[faq].shortquestion}</a></li>
      {else}
         <li><a href="/faqs/faq_test.php#faqid{$faqs[faq].faqid}">{$faqs[faq].question}</a></li>      
      {/if}
   {/section}
   </ul>
