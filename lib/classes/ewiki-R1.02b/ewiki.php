...
if (!class_exists("ewiki_database_mysql")) { include_once("plugins/db/mysql.php"); }
	...
	global $ewiki_config;
	global $ewiki_db;
	$ewiki_config["control_links_enclose"][0] = "<ul>";
	$ewiki_config["control_links_enclose"][1] = "<li>";
	$ewiki_config["control_links_enclose"][2] = "</li>";
	$ewiki_config["control_links_enclose"][3] = "</ul>";
	// end JBA
