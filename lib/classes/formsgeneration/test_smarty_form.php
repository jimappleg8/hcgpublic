 ...
 *
 * @(#) $Header: /home/mlemos/cvsroot/forms/test_smarty_form.php,v 1.11 2004/07/14 08:32:45 mlemos Exp $
 *
 */
 ...
 */
	$subscription->ResubmitConfirmMessage="Are you sure you want to submit this form again?";

/*
 * Output previously set password values
 */
	$subscription->OutputPasswordValues=1;
 ...
 */
	$subscription->LoadInputValues($subscription->WasSubmitted("doit"));
 ...
 * for the first time.
 */
	if($subscription->WasSubmitted("doit"))
	{
 ...
 */
		if(($error_message=$subscription->Validate($verify))=="")
		{
 ...
 */
	...
	{
		$smarty->assign_by_ref("form",$subscription);
	...
	{
		$subscription->AddDataPart("<h2><center>Please copy the template file <tt>templates/form.tpl</tt> to your Smarty <tt>templates</tt> directory.</center></h2>\n");
		$doit=1;
	}
...
/*
 * If the form was submitted and was valid, do not define the variable that
 * defines the Javascript code for page ONLOAD event.
 */
		$onload="";
	}
	else
 ...
 */
		...
		$subscription->AddFunction(array(
			"Function"=>"PageLoad",
			"Type"=>"focus",
			"Element"=>(count($verify) ? Key($verify) : "email")
		));
	}
 ...
 */
	...
	{
		$smarty->assign("form",FormCaptureOutput($subscription,array("EndOfLine"=>"\n")));
