...
//	define("EWIKI_DB_TABLE_NAME", "ewiki");      // MySQL / ADOdb
	...
	define("EWIKI_INIT_PAGES", EWIKI_BASE_DIR."init-pages");  // for initialization
...
//	define("EWIKI_LOGFILE", "/tmp/ewiki.log");
	...
	// ADDED JBA
	$ewiki_config["action_links"]["view"] = (isset($ewiki_config["action_links"]["view"])) ? $ewiki_config["action_links"]["view"] : array();
	$ewiki_config["action_links"]["info"] = (isset($ewiki_config["action_links"]["info"])) ? $ewiki_config["action_links"]["info"] : array();
	// end JBA
...
//        echo '<pre>'; print_r($ewiki_config); echo '</pre>'; exit;

	// text  (never remove the "C" or "en" sections!)

	// ADDED JBA
	$ewiki_t["C"] = (isset($ewiki_t["C"])) ? $ewiki_t["C"] : array();
	$ewiki_t["en"] = (isset($ewiki_t["en"])) ? $ewiki_t["en"] : array();
	$ewiki_t["es"] = (isset($ewiki_t["es"])) ? $ewiki_t["es"] : array();
	$ewiki_t["de"] = (isset($ewiki_t["de"])) ? $ewiki_t["de"] : array();
	// end JBA
	...
	// InterWiki:Links
	// ADDED JBA
	$ewiki_config["interwiki"] = (isset($ewiki_config["interwiki"])) ? $ewiki_config["interwiki"] : array();
	// end JBA
...
function ewiki_binary($break=0) {
   ...
   if ($do == "upload"){
      ...
      if ($id) {
         echo<<<EOF
<html><head><meta charset="macintosh" />
<title>File/Picture Upload</title><script language="JavaScript" type="text/javascript"><!--
