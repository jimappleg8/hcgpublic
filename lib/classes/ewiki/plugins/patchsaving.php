...
function ewiki_edit_patch($id, &$data) {
   ...
   $fn_base = "/tmp/ewiki.base.".md5($base["content"]);
   $fn_requ = "/tmp/ewiki..requ.".md5($_REQUEST["content"]);
   $fn_patch = "/tmp/ewiki.patch.".md5($base["content"])."-".md5($_REQUEST["content"]);
   $fn_curr = "/tmp/ewiki.curr.".md5($data["content"]);
