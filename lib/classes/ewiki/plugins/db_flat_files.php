...
function ewiki_database_files ($FUNC, $args=array(), $sw1=0, $sw2=0) {
   ...
   switch (trim($FUNC)) {
	...
	if (($FUNC=="OVERWRITE") || !file_exists($dbfile = ewiki_database_files("FN", $args['id'].".$n")))
        {
	...
	break;
      ...
      case "DELETE":
         $fn = ewiki_database_files("FN", $args["id"]);
         $n = $args["version"];
         @unlink(EWIKI_DBFILES_DIRECTORY . DIRECTORY_SEPARATOR . $fn . ".$n");
         break;
   }
