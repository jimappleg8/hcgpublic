...
/*
   ...
   hold large files (because it reads records in one chunk), you need
   ...
   - You must load this plugin __before__ the main script, because the
     binary stuff therein is engaged automatically.
...
define("EWIKI_DB_STORE_MAXSIZE", 32 <<20);	// 32MB max per file
