<?php
 ...
 # ewiki.php (you must include() it __after__ "ewiki.php" or edit it
 # by hand)
 # it was merged from PhpWiki's "interwiki.map" and a InterWiki list
 # found on MoinMoin
 ...
 array(
	...
	"PhpFuntion"	=>	"http://www.php.net/manual/en/function.",
