...
$ewiki_plugins["action_links"]["view"][EWIKI_ACTION_ATTACHMENTS] = "Attachments";
...
$ewiki_t["en"]["UPL_OK"] = "Your file was uploaded correctly, please see <a href=\"".EWIKI_SCRIPT.EWIKI_PAGE_DOWNLOAD."\">".EWIKI_PAGE_DOWNLOAD."</a>.<br><br>";
$ewiki_t["en"]["UPL_ERROR"] = "We're sorry, but something went wrong during the file upload.<br><br>";
$ewiki_t["en"]["DWNL_SEEUPL"] = 'See also <a href="'.EWIKI_SCRIPT.EWIKI_PAGE_UPLOAD.'">FileUpload</a>, this page is only about downloading.<br><br>';
...
$ewiki_t["de"]["UPL_OK"] = "Deine Datei wurde korrekt hochgeladen, sehe einfach auf der <a href=\"".EWIKI_SCRIPT.EWIKI_PAGE_DOWNLOAD."\">".EWIKI_PAGE_DOWNLOAD."</a> nach.<br><br>";
$ewiki_t["de"]["UPL_ERROR"] = "'Tschuldige, aber irgend etwas ist während des Hochladens gründlich schief gelaufen.<br><br>";
$ewiki_t["de"]["DWNL_SEEUPL"] = 'Siehe auch <a href="'.EWIKI_SCRIPT.EWIKI_PAGE_UPLOAD.'">DateiHochladen</a>, auf dieser Seite stehen nur die Downloads.<br><br>';
...
function ewiki_page_fileupload($id, $data, $action, $def_sec="") {
   ...
   (EWIKI_PRINT_TITLE) and ($o = "<h2>" . EWIKI_PAGE_UPLOAD . "</h2>\n");
